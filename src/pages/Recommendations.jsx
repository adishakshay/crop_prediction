...
//  * - Multi-language integrated (English, Hindi, Sanskrit)
//  * - Labels, buttons, placeholders auto-change with profile language
//  * - Added 🔊 (speak) + 🎤 (voice input) for Soil Type, Previous Crop, Land Acres
//  */
...
//       <form className="recommendation-form" onSubmit={handleSubmit}>
//         {/* --- Location Mode selector etc stays same --- */}
...
//         {/* Soil Type with 🔊 + 🎤 */}
//         <div className="recommendation-form-group">
//           <label onClick={() => speak(t.soilType)}>
//             {t.soilType} 🔊
//           </label>
//           <select
//             name="soilType"
...
//             onClick={() =>
//               startListening((text) =>
//                 setFormData((prev) => ({ ...prev, soilType: text }))
//               )
//             }
//           >
//             🎤 Speak
...
//         {/* Water Sources (unchanged) */}

//         {/* Previous Crop with 🔊 + 🎤 */}
//         <div className="recommendation-form-group">
//           <label onClick={() => speak(t.previousCrop)}>
//             {t.previousCrop} 🔊
//           </label>
//           <input
//             type="text"
...
//             onClick={() =>
//               startListening((text) =>
//                 setFormData((prev) => ({ ...prev, previousCrop: text }))
//               )
//             }
//           >
//             🎤 Speak
...
//         {/* Expected Seeding (unchanged) */}

//         {/* Land Acres with 🔊 + 🎤 */}
//         <div className="recommendation-form-group">
//           <label onClick={() => speak(t.landAcres)}>
//             {t.landAcres} 🔊
//           </label>
//           <input
//             type="number"
...
//             onClick={() =>
//               startListening((text) =>
//                 setFormData((prev) => ({ ...prev, landAcres: text }))
//               )
//             }
//           >
//             🎤 Speak
...
//         {/* Cropping Type + Crop Category stay same */}
